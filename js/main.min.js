...
$(document).ready(function() {
    ...
    //menu-nav
    const list = document.querySelectorAll('.services-main__top-link')
    list.forEach(item =>{
        item.addEventListener('click', (e) =>{
            list.forEach(el=>{ el.classList.remove('services-main__top-link--active'); });
            item.classList.add('services-main__top-link--active')
        })
    })
    ...
    $(".services-main__top-btn").click(function() {
        $(this).toggleClass("services-main__top-btn--active")
        $(".services-main__menu").toggleClass("services-main__menu--active")
        $("body").toggleClass("fixed-body")
    })

    // portfolio
    $(".portfolio__mob-btn").click(function() {
        $(this).toggleClass("portfolio__mob-btn--active")
        $(".portfolio__mob-menu").toggleClass("portfolio__mob-menu--active")
        $(".portfolio__btn-close").toggleClass("portfolio__btn-close--active")
        $("body").toggleClass("fixed-body")
    })
